...
5. Schreibe GitHub Actions für:
   ...
   * Continuous Delivery (GitHub Packages) **(2 Punkte)** (1)
   * Continuous Deployment (GitHub Pages) **(2 Punkte)** (1) *Die Action ist richtig, allerdings sind die Einstellungen in GitHub nicht so, dass das Deployment funktioniert*
